...
const Input: React.FC<InputProps> = ({
  ...
  if (disabled) {
    ...
    inputClasses +=
      " text-error-800 border-error-500 focus:ring-error-500/10 " +
      "dark:text-error-400 dark:border-error-500";
  } else if (success) {
    inputClasses +=
      " text-success-500 border-success-400 focus:ring-success-500/10 " +
  ...
  return (
    <div className="relative">
      <input
        {...props}        // ← value, onChange, type, name, dll
        disabled={disabled}
